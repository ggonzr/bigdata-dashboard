...
Panel de control para la ejecución de los requerimientos funcionales del taller, se construye sobre el proyecto _Open Source_ de __Creative Tim__ cuya descripción se encuentra mas adelante.
